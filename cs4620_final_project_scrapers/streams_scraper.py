...
url = "https://kworb.net/spotify/songs.html"  # url of website to scrape
...
if response.status_code == 200:
    ...
    if table:
        ...
        for row in rows:
            ...
            daily_stream_cell = cell_parts[2]
            # pull text out of the cells, print recombined strings
            print(title_artist_cell.text.strip() + '-' + stream_cell.text.strip() + '-' + daily_stream_cell.text.strip())
    else:
